...
This is a fun little trivia web app created with React and Material-UI icons, the data was shared by [Tandem](madeintandem.com) for their software engineer apprenticeship coding challenge.
